    ...
    <x-slot name="header">
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div class="flex gap-3">
                {{-- Tombol Hasil Penjualan --}}
                <a href="{{ route('mitra.sales') }}" class="inline-flex items-center justify-center px-5 py-2.5 text-sm font-medium text-green-500 bg-gray-800 rounded-lg hover:bg-gray-700 transition border border-green-500/30 hover:border-green-400 hover:shadow-lg hover:shadow-green-500/20">
